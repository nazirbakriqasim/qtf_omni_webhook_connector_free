# -*- coding: utf-8 -*-
{
    ...
    'description': 'A completely free, open-source universal webhook engine developed by QTF to forward Odoo 18 internal chat messages to any messaging gateway or API endpoint dynamically.',
